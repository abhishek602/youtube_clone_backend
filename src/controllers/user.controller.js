...
const generateAccessAndRefreshTokens = async (userId) => {
  try {
    ...
    // saves with only passed fields not check for other fields
...
const loginUser = asyncHandler(async (req, res) => {
  // take out the username and password from the request body
  ...
  // check in db , find the user either by email or username
  ...
  // send token in form of cookie to client
